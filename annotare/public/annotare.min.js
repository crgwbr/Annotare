...
[],function(){return jQuery})})(window);(function(jQuery){jQuery.hotkeys={version:"0.8",specialKeys:{8:"backspace",9:"tab",13:"return",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"del",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9",106:"*",107:"+",109:"-",110:".",111:"/",112:"f1",113:"f2",114:"f3",115:"f4",116:"f5",117:"f6",118:"f7",119:"f8",
120:"f9",121:"f10",122:"f11",123:"f12",144:"numlock",145:"scroll",191:"/",224:"meta"},shiftNums:{"`":"~",1:"!",2:"@",3:"#",4:"$",5:"%",6:"^",7:"&",8:"*",9:"(","0":")","-":"_","=":"+",";":": ","'":'"',",":"<",".":">","/":"?","\\":"|"}};function keyHandler(handleObj){if(typeof handleObj.data!=="string")return;var origHandler=handleObj.handler,keys=handleObj.data.toLowerCase().split(" ");handleObj.handler=function(event){if(this!==event.target&&(/textarea|select/i.test(event.target.nodeName)||event.target.type===
"text"))return;var special=event.type!=="keypress"&&jQuery.hotkeys.specialKeys[event.which],character=String.fromCharCode(event.which).toLowerCase(),key,modif="",possible={};if(event.altKey&&special!=="alt")modif+="alt+";if(event.ctrlKey&&special!=="ctrl")modif+="ctrl+";if(event.metaKey&&!event.ctrlKey&&special!=="meta")modif+="meta+";if(event.shiftKey&&special!=="shift")modif+="shift+";if(special)possible[modif+special]=true;else{possible[modif+character]=true;possible[modif+jQuery.hotkeys.shiftNums[character]]=
true;if(modif==="shift+")possible[jQuery.hotkeys.shiftNums[character]]=true}for(var i=0,l=keys.length;i<l;i++)if(possible[keys[i]])return origHandler.apply(this,arguments)}}jQuery.each(["keydown","keyup","keypress"],function(){jQuery.event.special[this]={add:keyHandler}})})(jQuery);var JSON;if(!JSON)JSON={};(function(){function f(n){return n<10?"0"+n:n}if(typeof Date.prototype.toJSON!=="function"){Date.prototype.toJSON=function(key){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+f(this.getUTCMonth()+
1)+"-"+f(this.getUTCDate())+"T"+f(this.getUTCHours())+":"+f(this.getUTCMinutes())+":"+f(this.getUTCSeconds())+"Z":null};String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(key){return this.valueOf()}}var cx=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,escapable=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,gap,indent,meta={"\u0008":"\\b",
"\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},rep;function quote(string){escapable.lastIndex=0;return escapable.test(string)?'"'+string.replace(escapable,function(a){var c=meta[a];return typeof c==="string"?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+string+'"'}function str(key,holder){var i,k,v,length,mind=gap,partial,value=holder[key];if(value&&typeof value==="object"&&typeof value.toJSON==="function")value=value.toJSON(key);if(typeof rep==="function")value=
...
walk({"":j},""):j}throw new SyntaxError("JSON.parse");}})();var $,Backend,BackendController,Controller,Events,Flakey,JSON,LocalBackend,MemoryBackend,Model,ServerBackend,SocketIOBackend,Stack,Template,get_template;var __hasProp=Object.prototype.hasOwnProperty,__indexOf=Array.prototype.indexOf||function(item){for(var i=0,l=this.length;i<l;i++)if(__hasProp.call(this,i)&&this[i]===item)return i;return-1},__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];
function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child},__bind=function(fn,me){return function(){return fn.apply(me,arguments)}};Flakey={diff_patch:new diff_match_patch,settings:{diff_text:true,container:void 0,read_backend:"memory",base_model_endpoint:null,socketio_server:null,enabled_local_backend:true},status:{server_online:void 0}};jQuery.noConflict();$=Flakey.$=jQuery;JSON=Flakey.JSON=JSON;Flakey.init=function(config){var key,
value;for(key in config){if(!__hasProp.call(config,key))continue;value=config[key];Flakey.settings[key]=value}return Flakey.models.backend_controller=new Flakey.models.BackendController};Flakey.util={async:function(fn){return setTimeout(fn,0)},deep_compare:function(a,b){var compare_objects;if(typeof a!==typeof b)return false;compare_objects=function(a,b){var key,value;for(key in a){value=a[key];if(!(b[key]!=null))return false}for(key in b){value=b[key];if(!(a[key]!=null))return false}for(key in a){value=
a[key];if(value)switch(typeof value){case "object":if(!compare_objects(value,b[key]))return false;break;default:if(value!==b[key])return false}else if(b[key])return false}return true};switch(typeof a){case "object":if(!compare_objects(a,b))return false;break;default:if(a!==b)return false}return true},guid:function(){var guid;guid="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx";guid=guid.replace(/[xy]/g,function(c){var r,v;r=Math.random()*16|0;if(c==="x")v=r;else v=r&3|8;v.toString(16).toUpperCase();return v});
return guid},get_hash:function(){var hash;hash=window.location.hash;if(hash.indexOf("#")===0)hash=hash.slice(1);return hash},querystring:{parse:function(str){var key,pair,pairs,params,value,_i,_len;if(!str||str.constructor!==String)return{};pairs=str.split("&");params={};for(_i=0,_len=pairs.length;_i<_len;_i++){pair=pairs[_i];pair=pair.split("=");key=decodeURIComponent(pair[0]);value=decodeURIComponent(pair[1]);params[key]=value}return params},build:function(params){var key,pairs,value;if(!params||
params.constructor!==Object)return"";pairs=[];for(key in params){if(!__hasProp.call(params,key))continue;value=params[key];pairs.push(""+encodeURIComponent(key)+"="+encodeURIComponent(value))}return pairs.join("&")},update:function(params,merge){var hash,location,query;if(merge==null)merge=false;hash=Flakey.util.get_hash();if(hash.indexOf("?")){hash=hash.split("?");location=hash[0];query=Flakey.util.querystring.parse(hash[1])}else{location=hash;query={}}if(merge)$.extend(query,params);else query=
params;return window.location.hash=""+location+"?"+Flakey.util.querystring.build(query)}}};Events=function(){function Events(){}Events.prototype.events={};Events.prototype.register=function(event,fn,namespace){if(namespace==null)namespace="flakey";if(this.events[namespace]===void 0)this.events[namespace]={};if(this.events[namespace][event]===void 0)this.events[namespace][event]=[];this.events[namespace][event].push(fn);return this.events[namespace][event]};Events.prototype.trigger=function(event,
namespace,data){var fn,output,_i,_len,_ref;if(namespace==null)namespace="flakey";if(data==null)data={};if(this.events[namespace]===void 0)this.events[namespace]={};if(this.events[namespace][event]===void 0)return;output=[];_ref=this.events[namespace][event];for(_i=0,_len=_ref.length;_i<_len;_i++){fn=_ref[_i];output.push(fn(event,namespace,data))}return output};Events.prototype.clear=function(namespace){if(namespace==null)namespace="flakey";return this.events[namespace]={}};return Events}();Flakey.events=
new Events;Model=function(){Model.model_name=null;Model.fields=["id"];function Model(init_values){var key,value;this.id=Flakey.util.guid();this.versions=[];for(key in init_values){if(!__hasProp.call(init_values,key))continue;value=init_values[key];this[key]=value}}Model.all=function(){var m,obj,set,_i,_len,_ref;set=[];_ref=Flakey.models.backend_controller.all(this.model_name);for(_i=0,_len=_ref.length;_i<_len;_i++){obj=_ref[_i];m=new this;m["import"](obj);set.push(m)}return set};Model.find=function(query){var ar,
item,m,set,_i,_len;ar=Flakey.models.backend_controller.find(this.model_name,query);if(!ar.length)return[];set=[];for(_i=0,_len=ar.length;_i<_len;_i++){item=ar[_i];m=new this;m["import"](item);set.push(m)}return set};Model.get=function(id){var m,obj;obj=Flakey.models.backend_controller.get(this.model_name,id);if(!obj)return;m=new this;m["import"](obj);return m};Model.search=function(re,fields){var ar,item,key,m,query,set,_i,_j,_len,_len2;if(fields==null)fields=this.fields;query={};for(_i=0,_len=fields.length;_i<
_len;_i++){key=fields[_i];query[key]=re}ar=Flakey.models.backend_controller.search(this.model_name,query);if(!ar.length)return[];set=[];for(_j=0,_len2=ar.length;_j<_len2;_j++){item=ar[_j];m=new this;m["import"](item);set.push(m)}return set};Model.prototype["delete"]=function(){var event_key;Flakey.models.backend_controller["delete"](this.constructor.model_name,this.id);event_key="model_"+this.constructor.model_name.toLowerCase()+"_updated";return Flakey.events.trigger(event_key,void 0)};Model.prototype.rollback=
function(version_id){var exists,i,latest,version,_i,_j,_len,_len2,_ref,_ref2;if(parseInt(version_id)<this.versions.length){_ref=Array(parseInt(version_id));for(_i=0,_len=_ref.length;_i<_len;_i++){i=_ref[_i];this.pop_version()}}else{exists=false;_ref2=this.versions;for(_j=0,_len2=_ref2.length;_j<_len2;_j++){version=_ref2[_j];if(version.version_id===version_id)exists=true}if(!exists)throw new ReferenceError("Version "+version_id+" does not exist.");latest=this.versions[this.versions.length-1];while(latest.version_id!==
version_id&&this.versions.length>1){this.pop_version();latest=this.versions[this.versions.length-1]}}this["import"]({id:this.id,versions:this.versions});return this.write()};Model.prototype.save=function(callback){var diff,new_obj,old_obj;new_obj=this["export"]();old_obj=this.evolve();diff=this.diff(new_obj,old_obj);if(Object.keys(diff).length>0){this.push_version(diff);this.write(callback)}else if(callback!=null)callback();return true};Model.prototype.diff=function(new_obj,old_obj){var key,patches,
save,_i,_len,_ref;save={};_ref=this.constructor.fields;for(_i=0,_len=_ref.length;_i<_len;_i++){key=_ref[_i];if(!Flakey.util.deep_compare(new_obj[key],old_obj[key]))switch(new_obj[key].constructor){case Object:save[key]=$.extend(true,{},new_obj[key]);break;case Array:save[key]=$.extend(true,[],new_obj[key]);break;case String:old_obj[key]=old_obj[key]!=null?old_obj[key].toString():"";if(Flakey.settings.diff_text){patches=Flakey.diff_patch.patch_make(old_obj[key],new_obj[key]);save[key]={constructor:"Patch",
patch_text:Flakey.diff_patch.patch_toText(patches)}}else save[key]=new_obj[key];break;default:save[key]=new_obj[key]}}return save};Model.prototype["export"]=function(){var field,obj,_i,_len,_ref;obj={};_ref=this.constructor.fields;for(_i=0,_len=_ref.length;_i<_len;_i++){field=_ref[_i];obj[field]=this[field]}return obj};Model.prototype.evolve=function(version_id,versions){var key,obj,patches,rev,saved,value,_i,_len,_ref;obj={};if(versions===void 0||versions.constructor!==Array){saved=Flakey.models.backend_controller.get(this.constructor.model_name,
this.id);versions=saved!=null?saved.versions:{}}for(_i=0,_len=versions.length;_i<_len;_i++){rev=versions[_i];_ref=rev.fields;for(key in _ref){if(!__hasProp.call(_ref,key))continue;value=_ref[key];switch(value.constructor){case "Patch":patches=Flakey.diff_patch.patch_fromText(value.patch_text);obj[key]=Flakey.diff_patch.patch_apply(patches,obj[key]||"")[0];break;case Object:obj[key]=$.extend(true,{},value);break;case Array:obj[key]=$.extend(true,[],value);break;default:obj[key]=value}}if(version_id!==
void 0&&version_id===rev.version_id)return obj}return obj};Model.prototype["import"]=function(obj){var key,value,_i,_len,_ref,_ref2,_results;this.versions=obj.versions;this.id=obj.id;_ref=this.constructor.fields;for(_i=0,_len=_ref.length;_i<_len;_i++){key=_ref[_i];this[key]=void 0}_ref2=this.evolve(void 0,this.versions);_results=[];for(key in _ref2){if(!__hasProp.call(_ref2,key))continue;value=_ref2[key];_results.push(this[key]=value)}return _results};Model.prototype.pop_version=function(){if(this.versions.length>
0)return this.versions.pop()};Model.prototype.push_version=function(diff){var version,version_id;version_id=Flakey.util.guid();version={version_id:version_id,time:+new Date,fields:$.extend(true,{},diff)};Object.freeze(version);return this.versions.push(version)};Model.prototype.write=function(callback){var _this=this;return Flakey.util.async(function(){var event_key;Flakey.models.backend_controller.save(_this.constructor.model_name,_this.id,_this.versions);if(callback!=null)callback();event_key="model_"+
_this.constructor.model_name.toLowerCase()+"_updated";return Flakey.events.trigger(event_key,void 0)})};return Model}();BackendController=function(){function BackendController(){this.delim=":::";this.backends={memory:{log_key:"flakey-memory-log",pending_log:[],"interface":new MemoryBackend}};if(Flakey.settings.enabled_local_backend)this.backends["local"]={log_key:"flakey-local-log",pending_log:[],"interface":new LocalBackend};if(Flakey.settings.base_model_endpoint)this.backends["server"]={log_key:"flakey-server-log",
pending_log:[],"interface":new ServerBackend};if(Flakey.settings.socketio_server)this.backends["socketio"]={log_key:"flakey-socketio-log",pending_log:[],"interface":new SocketIOBackend};this.read=Flakey.settings.read_backend||"memory";this.load_logs()}BackendController.prototype.all=function(name){return this.backends[this.read].interface.all(name)};BackendController.prototype.get=function(name,id){return this.backends[this.read].interface.get(name,id)};BackendController.prototype.find=function(name,
query){return this.backends[this.read].interface.find(name,query,false)};BackendController.prototype.search=function(name,re){return this.backends[this.read].interface.find(name,re,true)};BackendController.prototype.save=function(name,id,versions,backends){var backend,bname,log_msg;if(backends==null)backends=this.backends;for(bname in backends){if(!__hasProp.call(backends,bname))continue;backend=backends[bname];log_msg="save"+this.delim+JSON.stringify([name,id,versions]);if(backend.pending_log.length){backend.pending_log.push(log_msg);
this.commit_logs();this.exec_log();return false}if(!backend.interface.save(name,id,versions)){backend.pending_log.push(log_msg);this.commit_logs();return false}}return true};BackendController.prototype["delete"]=function(name,id,backends){var backend,bname,log_msg;if(backends==null)backends=this.backends;for(bname in backends){if(!__hasProp.call(backends,bname))continue;backend=backends[bname];log_msg="delete"+this.delim+JSON.stringify([name,id]);if(backend.pending_log.length){backend.pending_log.push(log_msg);
this.commit_logs();this.exec_log();return false}if(!backend.interface["delete"](name,id)){backend.pending_log.push(log_msg);this.commit_logs();return false}}return true};BackendController.prototype.exec_log=function(){var action,backend,bends,fn,log,msg,name,params,_i,_len,_ref;_ref=this.backends;for(name in _ref){if(!__hasProp.call(_ref,name))continue;backend=_ref[name];log=backend.pending_log;for(_i=0,_len=log.length;_i<_len;_i++){msg=log[_i];if(msg!=null){action=msg.split(this.delim);fn=Flakey.models.backend_controller.backends[name].interface[action[0]];
params=JSON.parse(action[1]);bends={};bends[name]=backend;params.push(bends);if(fn.apply(Flakey.models.backend_controller.backends[name].interface,params))backend.pending_log.shift();else break}}}return this.commit_logs()};BackendController.prototype.commit_logs=function(backends){var backend,name;if(backends==null)backends=this.backends;for(name in backends){if(!__hasProp.call(backends,name))continue;backend=backends[name];localStorage[backend.log_key]=JSON.stringify(backend.pending_log)}return true};
BackendController.prototype.load_logs=function(backends){var backend,name;if(backends==null)backends=this.backends;for(name in backends){if(!__hasProp.call(backends,name))continue;backend=backends[name];if(!(localStorage[backend.log_key]!=null))break;backend.pending_log=JSON.parse(localStorage[backend.log_key])}return true};BackendController.prototype.sync=function(name,backends){var backend,bname,event_key,item,key,output,store,_i,_len,_ref,_ref2;if(backends==null)backends=this.backends;store={};
for(bname in backends){if(!__hasProp.call(backends,bname))continue;backend=backends[bname];_ref=backend.interface.all(name);for(_i=0,_len=_ref.length;_i<_len;_i++){item=_ref[_i];if(_ref2=item.id,__indexOf.call(Object.keys(store),_ref2)>=0)store[item.id].versions=this.merge_version_lists(item.versions,store[item.id].versions);else store[item.id]=item}}output=[];for(key in store){if(!__hasProp.call(store,key))continue;item=store[key];output.push(item)}for(bname in backends){if(!__hasProp.call(backends,
bname))continue;backend=backends[bname];backend.interface._write(name,output)}event_key="model_"+name.toLowerCase()+"_updated";return Flakey.events.trigger(event_key,void 0)};BackendController.prototype.merge_version_lists=function(a,b){var key,keys,output,rev,temp,value,_i,_j,_len,_len2,_ref,_ref2,_ref3;temp={};_ref=a.concat(b);for(_i=0,_len=_ref.length;_i<_len;_i++){rev=_ref[_i];if(_ref2=rev.time,__indexOf.call(Object.keys(temp),_ref2)>=0)if(rev.id!==temp[rev.time].id){_ref3=rev.fields;for(key in _ref3){if(!__hasProp.call(_ref3,
key))continue;value=_ref3[key];temp[rev.time].fields[key]=value}}else temp[rev.time]=rev;else temp[rev.time]=rev}keys=Object.keys(temp);keys.sort(function(a,b){return a-b});output=[];for(_j=0,_len2=keys.length;_j<_len2;_j++){key=keys[_j];output.push(temp[key])}return output};return BackendController}();Backend=function(){function Backend(){}Backend.prototype.all=function(name){var store;store=this._read(name);if(!store)return[];return store};Backend.prototype["delete"]=function(name,id){var index,
store;store=this._read(name);index=this._query_by_id(name,id);if(index===-1)return true;store.splice(index,1);return this._write(name,store)};Backend.prototype.find=function(name,query,full_text){var i,out,set,store,_i,_len;if(full_text==null)full_text=false;store=this._read(name);set=full_text?this._search(name,query):this._query(name,query);out=[];for(_i=0,_len=set.length;_i<_len;_i++){i=set[_i];out.push(store[i])}return out};Backend.prototype.get=function(name,id){var index,store;store=this._read(name);
index=this._query_by_id(name,id);if(index===-1)return;return store[index]};Backend.prototype.save=function(name,id,versions){var index,obj,store;store=this._read(name);if(!store)store=[];index=this._query_by_id(name,id);obj={id:id,versions:versions};if(index===-1)store.push(obj);else store[index]=obj;return this._write(name,store)};Backend.prototype._query=function(name,query){var i,key,match,obj,rendered,set,store,value,_i,_len;store=this._read(name);if(!store)return[];set=[];i=0;for(_i=0,_len=store.length;_i<
_len;_i++){obj=store[_i];rendered=this._render_obj(obj);match=true;for(key in query){if(!__hasProp.call(query,key))continue;value=query[key];if(rendered[key]!==value)match=false}if(match)set.push(i);i++}return set};Backend.prototype._query_by_id=function(name,id){var i,obj,store,_i,_len;store=this._read(name);if(!store)return-1;i=0;for(_i=0,_len=store.length;_i<_len;_i++){obj=store[_i];if(obj.id===id)return i;i++}return-1};Backend.prototype._render_obj=function(obj){var key,output,patches,rev,value,
_i,_len,_ref,_ref2;output={};_ref=obj.versions;for(_i=0,_len=_ref.length;_i<_len;_i++){rev=_ref[_i];_ref2=rev.fields;for(key in _ref2){if(!__hasProp.call(_ref2,key))continue;value=_ref2[key];switch(value.constructor){case "Patch":patches=Flakey.diff_patch.patch_fromText(value.patch_text);obj[key]=Flakey.diff_patch.patch_apply(patches,obj[key]||"")[0];break;case Object:obj[key]=$.extend(true,{},value);break;case Array:obj[key]=$.extend(true,[],value);break;default:obj[key]=value}}}return obj};Backend.prototype._search=
function(name,query){var i,key,match,obj,rendered,set,store,value,_i,_len;store=this._read(name);if(!store)return[];for(key in query){if(!__hasProp.call(query,key))continue;value=query[key];query[key]=new RegExp(value,"g")}set=[];i=0;for(_i=0,_len=store.length;_i<_len;_i++){obj=store[_i];rendered=this._render_obj(obj);match=false;for(key in query){if(!__hasProp.call(query,key))continue;value=query[key];if(value.exec(rendered[key]))match=true}if(match)set.push(i);i++}return set};return Backend}();
MemoryBackend=function(){__extends(MemoryBackend,Backend);function MemoryBackend(){if(!window.memcache)window.memcache={}}MemoryBackend.prototype._read=function(name){return $.extend(true,[],window.memcache[name])};MemoryBackend.prototype._write=function(name,store){window.memcache[name]=$.extend(true,[],store);return true};return MemoryBackend}();LocalBackend=function(){__extends(LocalBackend,Backend);function LocalBackend(){this.prefix="flakey-"}LocalBackend.prototype._read=function(name){var store;
if(!localStorage[this.prefix+name])localStorage[this.prefix+name]=JSON.stringify([]);store=JSON.parse(localStorage[this.prefix+name]);return store};LocalBackend.prototype._write=function(name,store){localStorage[this.prefix+name]=JSON.stringify(store);return true};return LocalBackend}();ServerBackend=function(){__extends(ServerBackend,Backend);function ServerBackend(){this.server_cache={}}ServerBackend.prototype.build_endpoint_url=function(name,id,params){var querystring,url;url=""+Flakey.settings.base_model_endpoint+
"/"+name;if(id!=null)url+="/"+id;if(params!=null&&params.constructor===Object){querystring=Flakey.util.querystring.build(params);url+="?"+querystring}return url};ServerBackend.prototype.all=function(name){var obj,store,_i,_len;store=false;$.ajax({async:false,url:this.build_endpoint_url(name),dataType:"json",error:function(){return Flakey.status.server_online=false},success:function(data){Flakey.status.server_online=true;return store=data},type:"GET"});for(_i=0,_len=store.length;_i<_len;_i++){obj=
store[_i];this.save_to_cache(name,obj.id,obj.versions)}return store};ServerBackend.prototype.get=function(name,id){var obj;obj=false;$.ajax({async:false,url:this.build_endpoint_url(name,id),dataType:"json",error:function(){return Flakey.status.server_online=false},success:function(data){Flakey.status.server_online=true;return obj=data},type:"GET"});this.save_to_cache(name,obj.id,obj.versions);return obj};ServerBackend.prototype.get_from_cache=function(name,id){if(this.server_cache[name])if(this.server_cache[name][id])return this.server_cache[name][id]};
ServerBackend.prototype.save=function(name,id,versions,force_write){var cached_obj,proposed_obj,status;proposed_obj={id:id,versions:versions};cached_obj=this.get_from_cache(name,id);if(Flakey.util.deep_compare(proposed_obj,cached_obj)&&force_write!==true)return true;status=false;$.ajax({async:false,url:this.build_endpoint_url(name,id),data:Flakey.util.querystring.build({id:id,versions:JSON.stringify(versions)}),dataType:"json",error:function(){return Flakey.status.server_online=false},success:function(){Flakey.status.server_online=
true;return status=true},type:"POST"});return status};ServerBackend.prototype.save_to_cache=function(name,id,versions){this.server_cache[name]=this.server_cache[name]||{};return this.server_cache[name][id]=$.extend(true,{},{id:id,versions:versions})};ServerBackend.prototype["delete"]=function(name,id){var status;status=false;$.ajax({async:false,url:this.build_endpoint_url(name,id),dataType:"json",error:function(){return Flakey.status.server_online=false},success:function(){Flakey.status.server_online=
true;return status=true},type:"DELETE"});return status};ServerBackend.prototype._query=function(name,query){throw new TypeError("_query not supported on server backend");};ServerBackend.prototype._query_by_id=function(name,id){throw new TypeError("_query_by_id not supported on server backend");};ServerBackend.prototype._read=function(name){return this.all(name)};ServerBackend.prototype._write=function(name,store){var item,status,_i,_len;status=true;for(_i=0,_len=store.length;_i<_len;_i++){item=store[_i];
if(!this.save(name,item.id,item.versions))status=false}return status};return ServerBackend}();SocketIOBackend=function(){__extends(SocketIOBackend,Backend);function SocketIOBackend(){var _this=this;this.status=true;this.socket=window.socket=io.connect(Flakey.settings.socketio_server);this.server_cache={};this.socket.on("sync",function(set){var name,names,obj,_i,_j,_len,_len2,_ref,_results;names=[];for(_i=0,_len=set.length;_i<_len;_i++){obj=set[_i];if(_ref=obj.name,__indexOf.call(names,_ref)<0)names.push(obj.name);
_this.save_to_cache(obj.name,obj.id,obj.versions)}_results=[];for(_j=0,_len2=names.length;_j<_len2;_j++){name=names[_j];_results.push(Flakey.models.backend_controller.sync(name))}return _results});this.socket.emit("fetch_all")}SocketIOBackend.prototype.all=function(name){var id,store,_i,_len,_ref;store=[];this.server_cache[name]=this.server_cache[name]||{};_ref=Object.keys(this.server_cache[name]);for(_i=0,_len=_ref.length;_i<_len;_i++){id=_ref[_i];store.push(this.get_from_cache(name,id))}return store};
SocketIOBackend.prototype.get=function(name,id){return this.get_from_cache(name,id)};SocketIOBackend.prototype.get_from_cache=function(name,id){if(this.server_cache[name])if(this.server_cache[name][id])return this.server_cache[name][id]};SocketIOBackend.prototype.save=function(name,id,versions,force_write){var cached_obj,proposed_obj;var _this=this;proposed_obj={id:id,versions:versions};cached_obj=this.get_from_cache(name,id);if(Flakey.util.deep_compare(proposed_obj,cached_obj)&&force_write!==true)return true;
this.socket.emit("write",{name:name,id:id,versions:versions},function(){return _this.save_to_cache(name,id,versions)});return this.status};SocketIOBackend.prototype.save_to_cache=function(name,id,versions){this.server_cache[name]=this.server_cache[name]||{};return this.server_cache[name][id]=$.extend(true,{},{id:id,versions:versions})};SocketIOBackend.prototype["delete"]=function(name,id){this.socket.emit("delete",{name:name,id:id});return this.status};SocketIOBackend.prototype._query=function(name,
query){throw new TypeError("_query not supported on socketio backend");};SocketIOBackend.prototype._query_by_id=function(name,id){throw new TypeError("_query_by_id not supported on socketio backend");};SocketIOBackend.prototype._read=function(name){return this.all(name)};SocketIOBackend.prototype._write=function(name,store){var item,status,_i,_len;status=true;for(_i=0,_len=store.length;_i<_len;_i++){item=store[_i];if(!this.save(name,item.id,item.versions))status=false}return status};return SocketIOBackend}();
Flakey.models={Model:Model,BackendController:BackendController,backend_controller:null};Controller=function(){function Controller(config){var name,_i,_len,_ref;if(config==null)config={};this.active=this.active||false;this.actions=this.actions||{};this.id=this.id||"";this.class_name=this.class_name||"";this.parent=this.parent||null;this.container=this.container||null;this.container_html=this.container_html||"";this.subcontrollers=this.subcontrollers||[];this.query_params=this.query_params||{};this.container=
$(document.createElement("div"));this.container.html(this.container_html);this.parent=config.parent||Flakey.settings.container;this.parent.append(this.container);this.container.attr("id",this.id);_ref=this.class_name.split(" ");for(_i=0,_len=_ref.length;_i<_len;_i++){name=_ref[_i];this.container.addClass(name)}}Controller.prototype.append=function(){var Contr,contr,_i,_len,_results;_results=[];for(_i=0,_len=arguments.length;_i<_len;_i++){Contr=arguments[_i];contr=new Contr({parent:this.parent});_results.push(this.subcontrollers.push(contr))}return _results};
Controller.prototype.render=function(){return this.html("")};Controller.prototype.bind_actions=function(){var action,fn,hotkey,key,key_parts,selector,_ref,_results;_ref=this.actions;_results=[];for(key in _ref){if(!__hasProp.call(_ref,key))continue;fn=_ref[key];key_parts=key.split(" ");action=key_parts.shift();hotkey="";if(action==="keydown"||action==="keyup"||action==="keypress")hotkey=key_parts.shift();if((hotkey.indexOf("#")!==-1||hotkey.indexOf(".")!==-1)&&hotkey.indexOf("+")===-1){key_parts.shift(hotkey);
hotkey=""}selector=key_parts.join(" ");if(selector.length<=0)selector=document;if(hotkey)_results.push($(selector).bind(action,hotkey,this[fn]));else _results.push($(selector).bind(action,this[fn]))}return _results};Controller.prototype.unbind_actions=function(){return $(document).unbind()};Controller.prototype.html=function(htm){this.container_html=htm;this.container.html(this.container_html);return Flakey.events.trigger("html_updated")};Controller.prototype.make_active=function(){var sub,_i,_len,
_ref,_results;this.active=true;this.render();this.bind_actions();this.container.removeClass("passive").addClass("active");_ref=this.subcontrollers;_results=[];for(_i=0,_len=_ref.length;_i<_len;_i++){sub=_ref[_i];_results.push(sub.make_active())}return _results};Controller.prototype.make_inactive=function(){var sub,_i,_len,_ref,_results;this.active=false;this.unbind_actions();this.container.removeClass("active").addClass("passive");_ref=this.subcontrollers;_results=[];for(_i=0,_len=_ref.length;_i<
_len;_i++){sub=_ref[_i];_results.push(sub.make_inactive())}return _results};Controller.prototype.set_queryparams=function(params){var sub,_i,_len,_ref,_results;this.query_params=params;_ref=this.subcontrollers;_results=[];for(_i=0,_len=_ref.length;_i<_len;_i++){sub=_ref[_i];_results.push(sub.set_queryparams(params))}return _results};return Controller}();Stack=function(){function Stack(config){var contr,name,_i,_len,_ref,_ref2;if(config==null)config={};this.resolve=__bind(this.resolve,this);this.id=
this.id||"";this.class_name=this.class_name||"";this.active=this.active||false;this.controllers=this.controllers||{};this.routes=this.routes||{};this["default"]=this["default"]||"";this.active_controller=this.active_controller||"";this.parent=this.parent||null;this.query_params=this.query_params||{};this.container=$(document.createElement("div"));this.container.attr("id",this.id);_ref=this.class_name.split(" ");for(_i=0,_len=_ref.length;_i<_len;_i++){name=_ref[_i];this.container.addClass(name)}this.container.html(this.container_html);
this.parent=config.parent||Flakey.settings.container;this.parent.append(this.container);_ref2=this.controllers;for(name in _ref2){if(!__hasProp.call(_ref2,name))continue;contr=_ref2[name];this.controllers[name]=new contr({parent:this.container})}window.addEventListener("hashchange",this.resolve,false)}Stack.prototype.resolve=function(){var controller,controller_name,hash,location,name,new_controller,querystring,regex,route,_ref,_ref2;hash=Flakey.util.get_hash();new_controller=void 0;if(hash.length>
0){if(hash.indexOf("?")!==-1){hash=hash.split("?");location=hash[0];querystring=hash[1]}else{location=hash;querystring=""}new_controller=void 0;_ref=this.routes;for(route in _ref){if(!__hasProp.call(_ref,route))continue;controller_name=_ref[route];regex=new RegExp(route);if(location.match(route))new_controller=controller_name}}if(!new_controller){window.location.hash="#"+this["default"];return}this.active_controller=new_controller;this.controllers[this.active_controller].set_queryparams(Flakey.util.querystring.parse(querystring));
_ref2=this.controllers;for(name in _ref2){if(!__hasProp.call(_ref2,name))continue;controller=_ref2[name];if(name!==this.active_controller)this.controllers[name].make_inactive()}if(this.active){this.controllers[this.active_controller].make_active();this.controllers[this.active_controller].render()}return this.controllers[this.active_controller]};Stack.prototype.make_active=function(){this.resolve();if(this.controllers[this.active_controller]!==void 0){this.controllers[this.active_controller].make_active();
this.controllers[this.active_controller].render()}return this.active=true};Stack.prototype.make_inactive=function(){if(this.controllers[this.active_controller]!==void 0)this.controllers[this.active_controller].make_inactive();return this.active=false};Stack.prototype.set_queryparams=function(params){return this.query_params=params};return Stack}();Flakey.controllers={Stack:Stack,Controller:Controller};Template=function(){function Template(eco,name){this.eco=eco;this.name=name}Template.prototype.render=
function(context){if(context==null)context={};return this.eco(context)};return Template}();get_template=function(name,tobj){var template;template=tobj.ecoTemplates[name];return new Template(template,name)};Flakey.templates={get_template:get_template,Template:Template};if(typeof module!=="undefined"&&module!==null)module.exports=Flakey;if(window)window.Flakey=Flakey}).call(this)});
require.define("/controllers/annotare.js",function(require,module,exports,__dirname,__filename){(function(){var $,Flakey,Main;var __hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child};Flakey=require("flakey");$=Flakey.$;Main=function(){__extends(Main,Flakey.controllers.Stack);
function Main(config){var Detail,Edit,History,List,NewDocument;NewDocument=require("./new_document");List=require("./list");Detail=require("./detail");Edit=require("./edit");History=require("./history");this.id="main-stack";this.class_name="stack";this.controllers={new_document:NewDocument,list:List,detail:Detail,edit:Edit,history:History};this.routes={"^/new$":"new_document","^/list$":"list","^/detail$":"detail","^/edit$":"edit","^/history$":"history"};this["default"]="/list";Main.__super__.constructor.call(this,
config)}return Main}();module.exports=Main}).call(this)});
require.define("/controllers/new_document.js",function(require,module,exports,__dirname,__filename){(function(){var $,Document,Flakey,NewDocument,autoresize,settings,ui;var __bind=function(fn,me){return function(){return fn.apply(me,arguments)}},__hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=
parent.prototype;return child};Flakey=require("flakey");$=Flakey.$;autoresize=require("../lib/autoresize");ui=require("../lib/uikit");settings=require("../settings");Document=require("../models/Document");NewDocument=function(){__extends(NewDocument,Flakey.controllers.Controller);function NewDocument(config){this.discard=__bind(this.discard,this);this.save=__bind(this.save,this);this.id="new-document-view";this.class_name="new_document view";this.actions={"click .save":"save","click .discard":"discard"};
NewDocument.__super__.constructor.call(this,config);this.tmpl=Flakey.templates.get_template("new_document",require("../views/new_document"))}NewDocument.prototype.render=function(){this.html(this.tmpl.render({title:this.query_params.title}));this.unbind_actions();this.bind_actions();$("#new-editor").autoResize({extraSpace:100,maxHeight:2E3});$("#new-editor").blur();return $("#name").focus()};NewDocument.prototype.save=function(params){var doc,name,text;name=$("#name").val();text=$("#new-editor").val();
if(name.length>0&&text.length>0){doc=new Document({name:name,base_text:text});doc.generate_slug();doc.save();ui.info("Everything's Shiny Capt'n!",'"'+doc.name+'" was successfully saved.').hide(settings.growl_hide_after).effect(settings.growl_effect);return window.location.hash="#/detail?"+Flakey.util.querystring.build({id:doc.id})}};NewDocument.prototype.discard=function(params){return ui.confirm("There be Monsters!","Careful there Captain; are you sure you want to discard this document?").show(function(ok){if(ok)return window.location.hash=
"#/list"})};return NewDocument}();module.exports=NewDocument}).call(this)});
...
require.define("/settings.js",function(require,module,exports,__dirname,__filename){module.exports={growl_hide_after:5E3,growl_effect:"slide"}});
require.define("/models/Document.js",function(require,module,exports,__dirname,__filename){(function(){var Annotation,Document,File,Flakey,Showdown;var __hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child};Flakey=require("flakey");Showdown=require("../lib/showdown");
Annotation=require("./Annotation");File=require("./File");Document=function(){__extends(Document,Flakey.models.Model);function Document(){Document.__super__.constructor.apply(this,arguments)}Document.model_name="Document";Document.fields=["id","name","slug","base_text","annotations","files"];Document.prototype.annotate=function(selection,html,attachment){var note,type;if(attachment===void 0)type="highlight";else type="note";note=new Annotation({text:selection,type:type,attachment:attachment,document:this.id});
note.save();if(!this.annotations||this.annotations.constructor!==Array)this.annotations=[];this.annotations.push(note.id);this.save();return note.apply(html)};Document.prototype.attach_file=function(raw_file,callback){var reader;var _this=this;if(callback==null)callback=void 0;if(!this.files||this.files.constructor!==Array)this.files=[];reader=new FileReader;reader.onload=function(event){var data,file,mime;mime=raw_file.type||"text/plain";data=event.target.result+"";if(data.slice(5,11)==="base64")data=
"data:text/plain;"+data.substr(5);file=new File({name:raw_file.fileName,size:raw_file.fileSize,last_modified:raw_file.lastModifiedDate,mime:mime,data:data,date_uploaded:new Date});file.save();_this.files.push(file.id);_this.save();if(callback)return callback(file)};return reader.readAsDataURL(raw_file)};Document.prototype["delete"]=function(){var file,file_id,note,note_id,_i,_j,_len,_len2,_ref,_ref2;if(this.annotations!=null){_ref=this.annotations;for(_i=0,_len=_ref.length;_i<_len;_i++){note_id=_ref[_i];
note=Annotation.get(note_id);if(note!=null)note["delete"]()}}if(this.files!=null){_ref2=this.files;for(_j=0,_len2=_ref2.length;_j<_len2;_j++){file_id=_ref2[_j];file=File.get(file_id);if(file!=null)file["delete"]()}}return Document.__super__["delete"].call(this)};Document.prototype.delete_annotation=function(id){var index;index=this.annotations.indexOf(id);if(index!==-1){this.annotations.splice(index,1);return this.save()}};Document.prototype.delete_file=function(file_id){var index;index=this.files.indexOf(file_id);
if(index!==-1){this.files.splice(index,1);return this.save()}};Document.prototype.draw_annotations=function(html,annotations){var note,note_id,_i,_len;if(annotations==null)annotations=this.annotations;if(!annotations||annotations.constructor!==Array)annotations=[];for(_i=0,_len=annotations.length;_i<_len;_i++){note_id=annotations[_i];note=Annotation.get(note_id);if(note!=null)html=note.apply(html)}return html};Document.prototype.generate_slug=function(){var slug;slug=this.name;slug=slug.toLowerCase().replace(/[^\_\ 0-9a-z-]/g,
"").replace(/[ ]/g,"_");this.slug=slug;return slug};Document.prototype.get_files=function(){var file,files,id,_i,_len,_ref;if(!this.files||this.files.constructor!==Array)this.files=[];files=[];_ref=this.files;for(_i=0,_len=_ref.length;_i<_len;_i++){id=_ref[_i];file=File.get(id);if(file!=null)files.push(file)}return files};Document.prototype.get_notes=function(){var id,note,notes,_i,_len,_ref;if(!this.annotations||this.annotations.constructor!==Array)this.annotations=[];notes=[];_ref=this.annotations;
for(_i=0,_len=_ref.length;_i<_len;_i++){id=_ref[_i];note=Annotation.get(id);if(note!=null)notes.push(note)}return notes};Document.prototype.render=function(){var converter,html;converter=new Showdown.converter;html=converter.makeHtml(this.base_text);return html};return Document}();module.exports=Document}).call(this)});
...
require.define("/models/Annotation.js",function(require,module,exports,__dirname,__filename){(function(){var Annotation,Flakey;var __bind=function(fn,me){return function(){return fn.apply(me,arguments)}},__hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child};Flakey=
require("flakey");Annotation=function(){__extends(Annotation,Flakey.models.Model);function Annotation(){this.apply=__bind(this.apply,this);Annotation.__super__.constructor.apply(this,arguments)}Annotation.model_name="Annotation";Annotation.fields=["id","text","type","attachment","document"];Annotation.prototype.apply=function(html){var note,parts,text,_i,_len;parts=this.text.split("\n");for(_i=0,_len=parts.length;_i<_len;_i++){text=parts[_i];if(this.type==="note")note='<span id="note-'+this.id+'" class="'+
this.type+'">'+text+'<span contenteditable="true" id="note-detail-'+this.id+'" class="note-detail">'+this.attachment+"</span></span>";else note='<span id="note-'+this.id+'" class="'+this.type+'">'+text+"</span>";html=html.replace(text,note)}return html};return Annotation}();module.exports=Annotation}).call(this)});
require.define("/models/File.js",function(require,module,exports,__dirname,__filename){(function(){var File,Flakey;var __hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child};Flakey=require("flakey");File=function(){__extends(File,Flakey.models.Model);function File(){File.__super__.constructor.apply(this,
arguments)}File.model_name="File";File.fields=["id","name","size","last_modified","mime","data","date_uploaded"];return File}();module.exports=File}).call(this)});
...
__out.push(__sanitize(this.title));__out.push('" />\n  \n      <textarea id="new-editor" placeholder="Far out in the uncharted backwaters of the unfashionable end of the Western Spiral arm of the Galaxy lies a small unregarded yellow sun..."></textarea>\n    </article>\n  </section>\n</div>')}).call(this)}).call(__obj);__obj.safe=__objSafe,__obj.escape=__escape;return __out.join("")}}).call(this)});
require.define("/controllers/list.js",function(require,module,exports,__dirname,__filename){(function(){var $,Document,Flakey,List;var __bind=function(fn,me){return function(){return fn.apply(me,arguments)}},__hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child};
Flakey=require("flakey");$=Flakey.$;Document=require("../models/Document");List=function(){__extends(List,Flakey.controllers.Controller);function List(config){this.search=__bind(this.search,this);this.new_document=__bind(this.new_document,this);this.render=__bind(this.render,this);this.id="list-view";this.class_name="list view";this.actions={"click .document":"select_doc","click .new_document":"new_document","keyup #search-box":"search"};List.__super__.constructor.call(this,config);this.tmpl=Flakey.templates.get_template("list",
...
(this.query_params.q!=null?Flakey.util.querystring.build({title:this.query_params.q}):"")};List.prototype.select_doc=function(event){var id;id=$(event.currentTarget).attr("id").replace("document-","");return window.location.hash="#/detail?"+Flakey.util.querystring.build({id:id})};List.prototype.search=function(event){event.preventDefault();return Flakey.util.querystring.update({q:$("#search-box").val()},true)};return List}();module.exports=List}).call(this)});
...
__objSafe=__obj.safe,__escape=__obj.escape;__safe=__obj.safe=function(value){if(value&&value.ecoSafe)return value;else{if(!(typeof value!=="undefined"&&value!=null))value="";var result=new String(value);result.ecoSafe=true;return result}};if(!__escape)__escape=__obj.escape=function(value){return(""+value).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")};(function(){(function(){var doc,_i,_len,_ref;__out.push('<div class="wrap">\n  <section class="one-column">\n    <form id="search-form" action="#" method="GET">\n        <input type="text" id="search-box" name="search-box" placeholder="Search Notes" />\n    </form>\n    \n    ');
_ref=this.list;for(_i=0,_len=_ref.length;_i<_len;_i++){doc=_ref[_i];__out.push('\n      <article class="document" id="document-');__out.push(__sanitize(doc.id));__out.push('">\n        <section class="name"><h1>');__out.push(__sanitize(doc.name));__out.push('</h1></section>\n        <section class="content">\n          ');__out.push(doc.render());__out.push("\n        </section>\n      </article>\n    ")}__out.push("\n    \n    ");if(this.list.length===0){__out.push('\n    \t<article class="new_document">\n    \t  ');
if(this.query){__out.push('\n    \t    <section class="name"><h1>New Document: ');__out.push(__sanitize(this.query));__out.push("</h1></section>\n    \t  ")}else __out.push('\n    \t    <section class="name"><h1>New Document</h1></section>\n    \t  ');__out.push("\n    \t</article>\n    ")}__out.push('\n    \n    <div class="clear"></div>\n  </section>\n</div>')}).call(this)}).call(__obj);__obj.safe=__objSafe,__obj.escape=__escape;return __out.join("")}}).call(this)});
require.define("/controllers/detail.js",function(require,module,exports,__dirname,__filename){(function(){var $,Annotation,Detail,Document,Flakey,settings,ui;var __bind=function(fn,me){return function(){return fn.apply(me,arguments)}},__hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;
return child};Flakey=require("flakey");$=Flakey.$;ui=require("../lib/uikit");settings=require("../settings");Document=require("../models/Document");Annotation=require("../models/Annotation");Detail=function(){__extends(Detail,Flakey.controllers.Controller);function Detail(config){this.delete_file=__bind(this.delete_file,this);this.annotate=__bind(this.annotate,this);this.highlight=__bind(this.highlight,this);this["delete"]=__bind(this["delete"],this);this.edit_note=__bind(this.edit_note,this);this.edit=
__bind(this.edit,this);this.render=__bind(this.render,this);this.id="detail-view";this.class_name="detail view";this.actions={"click .edit":"edit","click .highlighter":"highlight","click .annotate":"annotate","click .delete":"delete","click .delete-file":"delete_file","blur .note-detail":"edit_note","keyup ctrl+e":"edit","keyup ctrl+h":"highlight","keyup ctrl+n":"annotate","keyup ctrl+backspace":"delete"};Detail.__super__.constructor.call(this,config);this.tmpl=Flakey.templates.get_template("detail",
require("../views/detail"))}Detail.prototype.render=function(){var context;if(!this.query_params.id)return;this.doc=Document.get(this.query_params.id);if(!(this.doc!=null))return;context={doc:this.doc};this.html(this.tmpl.render(context));this.unbind_actions();return this.bind_actions()};Detail.prototype.edit=function(event){event.preventDefault();return window.location.hash="#/edit?"+Flakey.util.querystring.build(this.query_params)};Detail.prototype.edit_note=function(event){var content,id,note,
target;event.preventDefault();target=$(event.target);id=target.attr("id").replace("note-detail-","");content=target.html().replace(/\<br\/\>/,"\n\n").replace(/\<([\w\d\/]*)\>/g," ");note=Annotation.get(id);note.attachment=content;note.type="note";return note.save()};Detail.prototype["delete"]=function(event){var _this=this;event.preventDefault();return ui.confirm("Be careful!","Are you sure you want to delete this document?").show(function(ok){if(ok){_this.doc["delete"]();return window.location.hash=
"#/list"}})};Detail.prototype.highlight=function(event){var html,selection;event.preventDefault();selection=void 0;if(window.getSelection)selection=window.getSelection();else if(document.selection)selection=document.selection.createRange();selection=selection.toString();if(selection.length===0)return ui.error("Well, you were right about this being a bad idea.","Please select some text first.").hide(settings.growl_hide_after).effect(settings.growl_effect);else{html=$("#detail-"+this.doc.slug).html();
html=this.doc.annotate(selection,html);return $("#detail-"+this.doc.slug).html(html)}};Detail.prototype.annotate=function(event){var html,options,selection;event.preventDefault();selection=void 0;if(window.getSelection)selection=window.getSelection();else if(document.selection)selection=document.selection.createRange();selection=selection.toString();if(selection.length===0)return ui.error("Well, you were right about this being a bad idea.","Please select some text first.").hide(settings.growl_hide_after).effect(settings.growl_effect);
else{html=$("#detail-"+this.doc.slug).html();options={input:true,animate:true};html=this.doc.annotate(selection,html,"Click here to edit this note.");$("#detail-"+this.doc.slug).html(html);this.unbind_actions();return this.bind_actions()}};Detail.prototype.delete_file=function(event){var _this=this;event.preventDefault();event.preventDefault();return ui.confirm("There be Monsters!","Are you sure you want to delete this annotation?").show(function(ok){var id;if(ok){id=$(event.target).attr("data-id");
_this.doc.delete_file(id);return $(event.target).parent().slideUp()}})};return Detail}();module.exports=Detail}).call(this)});
...
__safe,__objSafe=__obj.safe,__escape=__obj.escape;__safe=__obj.safe=function(value){if(value&&value.ecoSafe)return value;else{if(!(typeof value!=="undefined"&&value!=null))value="";var result=new String(value);result.ecoSafe=true;return result}};if(!__escape)__escape=__obj.escape=function(value){return(""+value).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")};(function(){(function(){var file,files,_i,_len;__out.push('<div class="tool-bar-wrap">\n  <nav class="tool-bar left">\n    <div>\n      <a href="#" class="edit">Edit</a>\n      <a href="#/history?id=');
...
__out.push('\n    </article>\n    \n    <aside>\n      &nbsp;\n    </aside>\n  </section>\n  \n  <div class="clear"></div>\n  \n  ');files=this.doc.get_files();__out.push("\n  ");if(files.length>0){__out.push('\n  <hr />\n  <section class="files">\n    <h2>Attached Files</h2>\n    <ul>\n      ');for(_i=0,_len=files.length;_i<_len;_i++){file=files[_i];__out.push('\n        <li data-id="');__out.push(__sanitize(file.id));__out.push('">\n          <a href="');__out.push(file.data);__out.push('" target="_blank">');
__out.push(__sanitize(file.name));__out.push(" (");__out.push(__sanitize(file.mime));__out.push(')</a>\n          &nbsp;\n          <a href="#" class="delete-file" data-id="');__out.push(__sanitize(file.id));__out.push('">[Delete]</a>\n        </li>\n      ')}__out.push("\n    </ul>\n  </section>\n  ")}__out.push("\n</div>")}).call(this)}).call(__obj);__obj.safe=__objSafe,__obj.escape=__escape;return __out.join("")}}).call(this)});
require.define("/controllers/edit.js",function(require,module,exports,__dirname,__filename){(function(){var $,Document,Edit,Flakey,autoresize,settings,ui;var __bind=function(fn,me){return function(){return fn.apply(me,arguments)}},__hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;
return child};Flakey=require("flakey");$=Flakey.$;autoresize=require("../lib/autoresize");ui=require("../lib/uikit");settings=require("../settings");Document=require("../models/Document");Edit=function(){__extends(Edit,Flakey.controllers.Controller);function Edit(config){this.drag_over=__bind(this.drag_over,this);this.drop_file=__bind(this.drop_file,this);this.delete_note=__bind(this.delete_note,this);this.delete_file=__bind(this.delete_file,this);this.discard=__bind(this.discard,this);this.save=
__bind(this.save,this);this.render=__bind(this.render,this);this.autosave=__bind(this.autosave,this);this.id="edit-view";this.class_name="edit_document view";this.actions={"click .save":"save","click .discard":"discard","click .delete":"delete_note","click .delete-file":"delete_file","keyup #edit-editor":"autosave","keyup esc #edit-editor":"discard","keyup esc":"discard","keyup ctrl+s #edit-editor":"save","keyup ctrl+s":"save"};Edit.__super__.constructor.call(this,config);this.tmpl=Flakey.templates.get_template("edit",
require("../views/edit"))}Edit.prototype.autosave=function(event){event.preventDefault();if(this.doc.base_text!==$("#edit-editor").val())return localStorage[this.autosave_key()]=$("#edit-editor").val()};Edit.prototype.autosave_key=function(){return"autosave-draft-"+this.doc.id};Edit.prototype.close_editor=function(){delete localStorage[this.autosave_key()];return window.location.hash="#/detail?"+Flakey.util.querystring.build({id:this.doc.id})};Edit.prototype.render=function(){var context,dropZone;
var _this=this;if(!this.query_params.id)return;this.doc=Document.get(this.query_params.id);context={doc:this.doc};this.html(this.tmpl.render(context));if(localStorage[this.autosave_key()]!=null&&localStorage[this.autosave_key()].length>0)ui.confirm("Restore?","An unsaved draft of this note was found. Would you like to restore it to the editor?").show(function(ok){if(ok)return $("#edit-editor").val(localStorage[_this.autosave_key()]);else return delete localStorage[_this.autosave_key()]});this.unbind_actions();
this.bind_actions();$("#edit-editor").autoResize({extraSpace:100,maxHeight:9E3});$("#edit-editor").blur().focus();dropZone=document.getElementById("edit-drop-zone");dropZone.addEventListener("dragover",this.drag_over,false);return dropZone.addEventListener("drop",this.drop_file,false)};Edit.prototype.save=function(event){event.preventDefault();this.doc.base_text=$("#edit-editor").val();this.doc.save();delete localStorage[this.autosave_key()];return ui.info("Everything's Shiny Capt'n!",'"'+this.doc.name+
'" was successfully saved.').hide(settings.growl_hide_after).effect(settings.growl_effect)};Edit.prototype.discard=function(event){var _this=this;event.preventDefault();if(this.doc.base_text===$("#edit-editor").val())return this.close_editor();return ui.confirm("There be Monsters!","Careful there Captain; are you sure you want to discard all unsaved changes to this document?").show(function(ok){if(ok)return _this.close_editor()})};Edit.prototype.delete_file=function(event){var _this=this;event.preventDefault();
event.preventDefault();return ui.confirm("There be Monsters!","Are you sure you want to delete this annotation?").show(function(ok){var id;if(ok){id=$(event.target).attr("data-id");_this.doc.delete_file(id);return $(event.target).parent().slideUp()}})};Edit.prototype.delete_note=function(event){var _this=this;event.preventDefault();return ui.confirm("There be Monsters!","Are you sure you want to delete this annotation?").show(function(ok){var id;if(ok){id=$(event.target).parent().attr("data-id");
_this.doc.delete_annotation(id);return $(event.target).parent().slideUp()}})};Edit.prototype.drop_file=function(event){var file,files,_i,_len,_results;var _this=this;event.stopPropagation();event.preventDefault();files=event.dataTransfer.files;_results=[];for(_i=0,_len=files.length;_i<_len;_i++){file=files[_i];_results.push(this.doc.attach_file(file,function(file){$(".files ul").append("<li data-id='"+file.id+"'><a href='"+file.data+"' target='_blank'>"+file.name+" ("+file.mime+")</a>&nbsp;<a href='#' class='delete-file' data-id='"+
file.id+"'>[Delete]</a></li>");_this.unbind_actions();return _this.bind_actions()}))}return _results};Edit.prototype.drag_over=function(event){event.stopPropagation();event.preventDefault();return event.dataTransfer.dropEffect="copy"};return Edit}();module.exports=Edit}).call(this)});
...
__objSafe=__obj.safe,__escape=__obj.escape;__safe=__obj.safe=function(value){if(value&&value.ecoSafe)return value;else{if(!(typeof value!=="undefined"&&value!=null))value="";var result=new String(value);result.ecoSafe=true;return result}};if(!__escape)__escape=__obj.escape=function(value){return(""+value).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")};(function(){(function(){var annotation,file,_i,_j,_len,_len2,_ref,_ref2;__out.push('<div class="tool-bar-wrap">\n  <nav class="tool-bar left">\n    <div>\n      <a href="#" class="discard">Close Editor</a>\n      <a href="#" class="save">Save Changes</a>\n    </div>\n  </nav>\n</div>\n\n<div class="wrap">\n  <section class="one-column">\n    <article>\n      <h1>Editing <em>');
__out.push(__sanitize(this.doc.name));__out.push('</em></h1>\n      <textarea id="edit-editor" placeholder="Far out in the uncharted backwaters of the unfashionable end of the Western Spiral arm of the Galaxy lies a small unregarded yellow sun...">');__out.push(__sanitize(this.doc.base_text));__out.push('</textarea>\n      \n      <div class="annotations">\n        <h2>Notes & Highlights</h2>\n        <div class="clear"></div>\n        ');_ref=this.doc.get_notes();for(_i=0,_len=_ref.length;_i<_len;_i++){annotation=
...
_ref2=this.doc.get_files();for(_j=0,_len2=_ref2.length;_j<_len2;_j++){file=_ref2[_j];__out.push('\n            <li data-id="');__out.push(__sanitize(file.id));__out.push('">\n              <a href="');__out.push(file.data);__out.push('" target="_blank">');__out.push(__sanitize(file.name));__out.push(" (");__out.push(__sanitize(file.mime));__out.push(')</a>\n              &nbsp;\n              <a href="#" class="delete-file" data-id="');__out.push(__sanitize(file.id));__out.push('">[Delete]</a>\n            </li>\n          ')}__out.push("\n        </ul>\n      </div>\n    </article>\n    \n  </section>\n</div>")}).call(this)}).call(__obj);
__obj.safe=__objSafe,__obj.escape=__escape;return __out.join("")}}).call(this)});
require.define("/controllers/history.js",function(require,module,exports,__dirname,__filename){(function(){var $,Document,File,Flakey,History,Showdown,ui;var __bind=function(fn,me){return function(){return fn.apply(me,arguments)}},__hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;
return child};Flakey=require("flakey");$=Flakey.$;ui=require("../lib/uikit");Showdown=require("../lib/showdown");Document=require("../models/Document");File=require("../models/File");History=function(){__extends(History,Flakey.controllers.Controller);function History(config){this.update=__bind(this.update,this);this.rollback=__bind(this.rollback,this);this.render=__bind(this.render,this);this.id="history-view";this.class_name="history view";this.actions={"change #version-input":"update","click #rollback":"rollback"};
History.__super__.constructor.call(this,config);this.tmpl=Flakey.templates.get_template("history",require("../views/history"));Flakey.events.register("model_document_updated",this.render)}History.prototype.render=function(){var context,doc,latest,max_version,time;if(!this.query_params.id)return;doc=Document.get(this.query_params.id);max_version=doc.versions.length-1;latest=doc.versions.length-1;time=doc.versions[latest].time;context={doc:doc,time:new Date(time),max_version:max_version};this.html(this.tmpl.render(context));
this.unbind_actions();return this.bind_actions()};History.prototype.rollback=function(event){var doc,time,version_index;var _this=this;event.preventDefault();version_index=$("#version-input").val();doc=Document.get(this.query_params.id);time=new Date(doc.versions[version_index].time);return ui.confirm("Be careful!","Are you sure you want to rollback to the version saved at "+time.toLocaleString()).show(function(ok){if(ok)return doc.rollback(doc.versions[version_index].version_id)})};History.prototype.update=
function(event){var converter,doc,file,file_id,html,rev,time,version_index,_i,_len,_ref,_results;version_index=$("#version-input").val();doc=Document.get(this.query_params.id);time=new Date(doc.versions[version_index].time);rev=doc.evolve(doc.versions[version_index].version_id);converter=new Showdown.converter;html=converter.makeHtml(rev.base_text);$("#history-time").html(time.toLocaleString());$("#history-content").html(doc.draw_annotations(html,rev.annotations));$("#history-files").html("");_ref=
rev.files;_results=[];for(_i=0,_len=_ref.length;_i<_len;_i++){file_id=_ref[_i];file=File.get(file_id);_results.push($("#history-files").append("<li data-id='"+file.id+"'><a target='_blank' href='"+file.data+"'>"+file.name+" ("+file.mime+")</a></li>"))}return _results};return History}();module.exports=History}).call(this)});
...
__safe,__objSafe=__obj.safe,__escape=__obj.escape;__safe=__obj.safe=function(value){if(value&&value.ecoSafe)return value;else{if(!(typeof value!=="undefined"&&value!=null))value="";var result=new String(value);result.ecoSafe=true;return result}};if(!__escape)__escape=__obj.escape=function(value){return(""+value).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")};(function(){(function(){var file,html,_i,_len,_ref;__out.push('<div class="tool-bar-wrap">\n  <nav class="tool-bar left">\n    <div>\n      <a href="#/detail?id=');
...
_ref=this.doc.get_files();for(_i=0,_len=_ref.length;_i<_len;_i++){file=_ref[_i];__out.push('\n        <li data-id="');__out.push(__sanitize(file.id));__out.push('">\n          <a href="');__out.push(file.data);__out.push('" target="_blank">');__out.push(__sanitize(file.name));__out.push(" (");__out.push(__sanitize(file.mime));__out.push(')</a>\n          &nbsp;\n          <a href="#" class="delete-file" data-id="');__out.push(__sanitize(file.id));__out.push('">[Delete]</a>\n        </li>\n      ')}__out.push("\n    </ul>\n  </section>\n</div>")}).call(this)}).call(__obj);
__obj.safe=__objSafe,__obj.escape=__escape;return __out.join("")}}).call(this)});
require.define("/index.js",function(require,module,exports,__dirname,__filename){(function(){var $,Annotare,App,Flakey;var __hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child};Flakey=window.Flakey=require("flakey");$=window.$=Flakey.$;Annotare=require("./controllers/annotare");
App=function(){__extends(App,Flakey.controllers.Controller);function App(){App.__super__.constructor.apply(this,arguments);this.annotare=new Annotare;this.append(this.annotare)}return App}();$(document).ready(function(){var annotare,settings;settings={container:$("#application"),base_model_endpoint:"/api"};Flakey.init(settings);Flakey.models.backend_controller.sync("Document");Flakey.models.backend_controller.sync("Annotation");Flakey.models.backend_controller.sync("File");annotare=window.Annotare=
new Annotare;return annotare.make_active()});module.exports=App}).call(this)});require("/index.js");
